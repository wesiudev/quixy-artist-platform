  ...
  return (
    <>
      <div className="mt-[66px] -mb-12">
        <div className={`w-full px-5 lg:px-[8vw] xl:px-[12vw] pt-12`}>
          <span className="font-sans font-bold py-3 ">
            ...
            /{" "}
            <Link
              href={`/blog/${polishToEnglish(post.blogType)}/${polishToEnglish(
                post.title
              )}`}
              className="hover:underline hover:underline-offset-2"
            >
            ...
            <div className="flex flex-col prose lg:prose-xl ">
              ...
              {post.sections.map((section: any, idx) => (
                <div id={`${polishToEnglish(section.title)}`} key={idx}>
                  <h2 className="leading-relaxed font-bold">{section.title}</h2>
                  <div
                    className=""
